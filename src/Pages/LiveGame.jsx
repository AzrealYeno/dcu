            ...
            <div className="games_container" >
                {config ?
                    <div  className='livegamescores_content'>
                        ...
                        (
                            <div  key={score.id} className={`empire_container ${score.id === winner ? "boxwinner" : ""}`}>
                                <div key={score.id} className={`livegamescore`}> 
                                    ...
                                    <div className={`background livegamescore_${score.id}_background ${index % 2 == 0 ? "": "background_odd"}`}></div>
                                </div>
